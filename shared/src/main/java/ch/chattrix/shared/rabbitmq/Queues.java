...
public class Queues {
    ...
    public static final String AUTH_LOGOUT_QUEUE = "auth.logout.queue";
    public static final String AUTH_REFRESH_QUEUE = "auth.refresh.queue";
    public static final String AUTH_GET_EMAIL_QUEUE = "auth.get.email.queue";
